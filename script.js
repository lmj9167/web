var RENDERER = {
  ...
  setParameters: function() {
    this.$window = $(window);
    this.$container10 = $("#jsi-particle-container");
    this.$canvas = $("<canvas />");
    this.context = this.$canvas
      .appendTo(this.$container10)
      .get(0)
      .getContext("2d");
    this.particles = [];
    this.watchIds = [];
  ...
  setup: function() {
    ...
    this.width = this.$container10.width();
    this.height = this.$container10.height();
  ...
  createParticles: function() {
    for (
      var i = 0,
        count =
          (this.BASE_PARTICLE_COUNT * this.width / 500 * this.height / 500) | 0;
      i < count;
      i++
    ) {
  ...
  bindEvent: function() {
    ...
    this.$container10.on("mousemove", this.controlForce.bind(this, true));
    this.$container10.on("mouseleave", this.controlForce.bind(this, false));
  },
  controlForce: function(on, event) {
    ...
    var offset = this.$container10.offset();
